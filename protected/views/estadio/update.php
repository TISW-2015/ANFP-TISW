...
$this->breadcrumbs=array(
	...
	$model->EST_correl=>array('view','id'=>$model->EST_correl),
	'Update',
);
...
$this->menu=array(
	...
	array('label'=>'View Estadio', 'url'=>array('view', 'id'=>$model->EST_correl)),
	array('label'=>'Manage Estadio', 'url'=>array('admin')),
);
?>

<h1>Update Estadio <?php echo $model->EST_correl; ?></h1>
