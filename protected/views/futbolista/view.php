...
$this->menu=array(
	...
	array('label'=>'Ver lesiones', 'url'=>array('//Lesion/admin','id'=>$model->FUT_correl)),
	array('label'=>'Agregar lesión', 'url'=>array('//Lesion/create','id'=>$model->FUT_correl)),
...
<h3>Detalle Futbolista <?php echo $model->FUT_nombre." ".$model->FUT_apellidoPat." ".$model->FUT_apellidoMat; ?></h3>
