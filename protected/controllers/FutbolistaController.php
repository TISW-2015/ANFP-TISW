...
class FutbolistaController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Futbolista');
	...
	{
		$model=Futbolista::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Futbolista $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='futbolista-form')
		{
