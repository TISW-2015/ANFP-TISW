...
class LesionController extends Controller
{
	...
	public function filters()
   {
	...
	{
		$dataProvider=new CActiveDataProvider('Lesion');
	 ...
	 * @return Lesion the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Lesion::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Lesion $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='lesion-form')
		{
