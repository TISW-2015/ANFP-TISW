...
class PerteneceController extends Controller
{
	...
	public function filters()
   {
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Pertenece'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('Pertenece');
	...
	{
		$model=Pertenece::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Pertenece $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='pertenece-form')
		{
